...
void main() {
	...
	if ( col.z==0 && col.y==1 && col.x==1 && y<horizon ) {
		...
		while ( colLower.z==0 && colLower.y==1 && colLower.x==1 && yLower < 1) {
			yLower = yLower + dy;
			colLower = texture(txtr,vec2(x,yLower),0.0);
		}
		...
		if ( yUpper+yLower==2*y || yUpper+yLower==2*y+dy || yUpper+yLower==2*y-dy) {
			while (true) {
				if ( colLeft2.z==0 && colLeft2.y==1 && colLeft2.x==1 && yLeft2 < 1 && yLeft2 > 0 && xLeft > 0) {
					...
					colLeft2 = texture(txtr,vec2(xLeft,yLeft2),0.0);
					colLeft3 = texture(txtr,vec2(xLeft,yLeft3),0.0);
				} else if ( colLeft1.z==0 && colLeft1.y==1 && colLeft1.x==1 && yLeft1 < 1 && yLeft1 > 0 && xLeft > 0) {
					yLeft1 = yLeft1 + dy;
					yLeft2 = yLeft1;
					yLeft3 = yLeft1 - dy;
					xLeft = xLeft - dx;
					...
					colLeft2 = texture(txtr,vec2(xLeft,yLeft2),0.0);
					colLeft3 = texture(txtr,vec2(xLeft,yLeft3),0.0);
				} else if ( colLeft3.z==0 && colLeft3.y==1 && colLeft3.x==1 && yLeft3 < 1 && yLeft3 > 0 && xLeft > 0) {
					yLeft1 = yLeft3 + dy;
					yLeft2 = yLeft3;
					yLeft3 = yLeft3 - dy;
					xLeft = xLeft - dx;
			...
			while (true) {
				if ( colRight2.z==0 && colRight2.y==1 && colRight2.x==1 && yRight2 < 1 && yRight2 > 0 && xRight < 1) {
					yRight1 = yRight2 + dy;
					yRight2 = yRight2;
					yRight3 = yRight2 - dy;
					xRight = xRight + dx;
					...
					colRight2 = texture(txtr,vec2(xRight,yRight2),0.0);
					colRight3 = texture(txtr,vec2(xRight,yRight3),0.0);
				} else if ( colRight1.z==0 && colRight1.y==1 && colRight1.x==1 && yRight1 < 1 && yRight1 > 0 && xRight < 1) {
					yRight1 = yRight1 + dy;
					yRight2 = yRight1;
					yRight3 = yRight1 - dy;
					xRight = xRight + dx;
					...
					colRight2 = texture(txtr,vec2(xRight,yRight2),0.0);
					colRight3 = texture(txtr,vec2(xRight,yRight3),0.0);
				} else if ( colRight3.z==0 && colRight3.y==1 && colRight3.x==1 && yRight3 < 1 && yRight3 > 0 && xRight < 1) {
					yRight1 = yRight3 + dy;
					yRight2 = yRight3;
					yRight3 = yRight3 - dy;
					xRight = xRight + dx;
