...
public class TabletControlParallelNoReactor {
    public static void main(String[] args){   
        ...
        Thread run_thread = new Thread(new Runnable(){
            public void run(){
                TabletControlParallelNoReactor robot = new TabletControlParallelNoReactor(vision_vals);
                robot.loop();
            }
        });
        run_thread.start();
    ...
    public TabletControlParallelNoReactor(double[] vision_vals){
