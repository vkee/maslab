...
public class VisionPrevious {
    public static void main(String[] args){
        final VisionPrevious vision = new VisionPrevious(1, 320, 240, false);
    ...
    public VisionPrevious(int camera_number, int width, int height, boolean display_on){
        this.WIDTH = width;
        this.HEIGHT = height;
